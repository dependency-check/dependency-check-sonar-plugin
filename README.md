[![Build Status](https://travis-ci.com/dependency-check/dependency-check-sonar-plugin.svg?branch=master)](https://travis-ci.com/dependency-check/dependency-check-sonar-plugin)
